                ...
                <div class="card mb-0">
                  <div class="card-body">
                    <ul class="nav nav-pills">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#">Lunas <span class="badge badge-primary">1</span></a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="#">Check Out <span class="badge badge-primary">0</span></a>
                      </li>
                    </ul>
                  </div>
                </div>
