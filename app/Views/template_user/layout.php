	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="/kamar/tipe" style="font-weight:bold;color:white; text-transform: uppercase;" class="nav-link">Rooms</a></li>
	          <li class="nav-item"><a href="/services" style="font-weight:bold;color:white; text-transform: uppercase;" class="nav-link">Service</a></li>
