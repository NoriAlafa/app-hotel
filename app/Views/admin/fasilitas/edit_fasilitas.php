                    ...
                    <div class="card shadow p-3 mb-5 bg-white rounded">
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="logo" value="<?=htmlspecialchars($fs['logo'])?>" >
                                </div>
                            </div>

                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Fasilitas Hotel</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" name="fasilitas_hotel" value="<?=$fs['fasilitas_hotel']?>" >
                                </div>
                            </div>
