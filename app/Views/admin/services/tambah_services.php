...
<div class="main-content">
        <section class="section">
          ...
          <form action="/insert/services" method="post" enctype="multipart/form-data">
          <?= csrf_field(); ?>
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" required class="form-control" name="services">
                      </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <textarea class="summernote-simple " required name="detail_services"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                          <input type="file" name="img" id="img" required  class="form-control" onchange="previewImg()" >
                      </div>
                    </div>
